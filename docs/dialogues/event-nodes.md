...
To **catch the signal**, you need to connect the [signal_event](/docs/class-reference/nodes/dialog-player#signal-event-signal) signal from the [DialogPlayer](/docs/class-reference/nodes/dialog-player.md) node where you run the dialogue. As shown in the [using dialogues section](/docs/dialogues/using-dialogues#using-dialogplayer-signals).
