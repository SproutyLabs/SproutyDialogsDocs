...
![New Default Dialog Box](@site/static/img/screenshots/dialog-boxes/new_default_dialog_box.png)
...
![Portrait On Dialog Example](@site/static/img/screenshots/dialog-boxes/portrait_on_dialog_example.png)
