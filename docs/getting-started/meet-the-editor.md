...
![Start View](../../static/img/screenshots/plugin_start_view.png)
...
![Dialogue Editor](../../static/img/screenshots/dialogue_editor.png)
...
![Play Example](../../static/img/screenshots/play_example.png)
...
![Character Editor](../../static/img/screenshots/character_editor.png)

You can learn more about characters in [create a character](create-a-character).

### Variable Editor

The variable editor allows you to create variables for use in dialogs. You can add variables of different types, group them, and edit them. These variables can be used for conditional events, displayed in dialogs, and much more.

![Variable Editor](../../static/img/screenshots/variable_editor.png)

> You can call variables within `{}` to use them in the text, as can be seen in `not_pass_alert`, which uses the variable `alert_color` to color the text.

At the bottom of the interface, you can see the text editor again, because the string field can be expanded in the same way as before with the dialog boxes.
