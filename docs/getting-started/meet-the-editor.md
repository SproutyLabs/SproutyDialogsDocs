...
The **current version of the plugin is shown at the bottom of the sidebar**. When you click on this button, you will see a popup with the plugin information, where you can update the plugin to a more recent version. **When there is a new version to install, it will be indicated with a <span style={{color:'orange'}}>colored button!</span>**
...
This not only gives you a larger view, but also allows you to use a toolbar to easily add [BBCode](https://docs.godotengine.org/en/latest/tutorials/ui/bbcode_in_richtextlabel.html) tags to your dialogue! **Change the color, size, font, add text effects, and much more!**
