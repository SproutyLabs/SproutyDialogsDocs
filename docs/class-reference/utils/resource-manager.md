...
<h3 id="release-resources-method">
  <span class="reference-type">func </span><code>release_resources</code><span class="parameters">(dialog_data: <a href="/docs/class-reference/resources/dialogue-data">SproutyDialogsDialogueData</a>, start_id: <a href="https://docs.godotengine.org/en/stable/classes/class_string.html">String</a>)</span><span class="return-type"> -> void</span>
</h3>
