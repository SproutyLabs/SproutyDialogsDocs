...
<h3 id="open-directory-method">
  <span class="reference-type">func </span><code>open_directory</code><span class="parameters">(open_dir: <a href="https://docs.godotengine.org/en/stable/classes/class_bool.html">bool</a>)</span><span class="return-type"> -> void</span>
</h3>
<p>Configure the field to open a directory instead of a file.</p>
<hr/>

<h3 id="disable-field-method">
  <span class="reference-type">func </span><code>disable_field</code><span class="parameters">(disable: <a href="https://docs.godotengine.org/en/stable/classes/class_bool.html">bool</a>)</span><span class="return-type"> -> void</span>
</h3>
