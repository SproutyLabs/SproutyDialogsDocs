...
![Settings Tab](@site/static/img/screenshots/settings/settings_tab.png)
...
- `Continue Input Action`: The input action that allows the dialog to continue.
  ...
  >
  > ![Default Input Action](@site/static/img/screenshots/settings/default_input_action.png)
...
- `Default portrait scene`: Default portrait scene that will be used as a template when creating a new portrait for a character. The root of the scene must be a node inherited from the [DialogPortrait](./class-reference/nodes/dialog-portrait.md) class.
  ...
  >
  > ![Default Portrait Scene](@site/static/img/screenshots/settings/default_portrait_scene.png)
...
- `Locales`: Set the locales into which the dialogs will be translated.
  ...
  >
  > ![Locales List](@site/static/img/screenshots/settings/locales_list.png)
  >
