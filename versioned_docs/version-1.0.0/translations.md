...
![Enable Translations](@site/static/img/screenshots/translations/enable_translations.png)
...
![Add Locales Image](@site/static/img/screenshots/settings/locales_list.png)
...
![Character Name Translations](@site/static/img/screenshots/characters/character_name_translations.png)
...
![CSV File in Dialogue](@site/static/img/screenshots/translations/csv_file_example.png)
