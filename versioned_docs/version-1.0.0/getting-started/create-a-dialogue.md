...
![New Dialogue](@site/static/img/screenshots/getting-started/create-a-dialogue/new_dialogue.png)
...
![Add Start Node](@site/static/img/screenshots/getting-started/create-a-dialogue/add_start_node.png)
...
![Add Dialogue Node](@site/static/img/screenshots/getting-started/create-a-dialogue/add_dialogue_node.png)
...
![Text Editor Add Tags](@site/static/img/screenshots/getting-started/create-a-dialogue/text_editor_add_tags.png)
...
![Text Editor Change Properties](@site/static/img/screenshots/getting-started/create-a-dialogue/text_editor_change_properties.png)
...
![Test Dialogue](@site/static/img/screenshots/getting-started/create-a-dialogue/test_dialogue.png)
