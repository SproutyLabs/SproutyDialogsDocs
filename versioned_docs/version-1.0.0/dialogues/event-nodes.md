...
![Set Variable Node](@site/static/img/screenshots/event-nodes/set_variable_node.png)
...
![Signal Node](@site/static/img/screenshots/event-nodes/signal_node.png)
...
![Wait Node](@site/static/img/screenshots/event-nodes/wait_node.png)
...
![Comment Node](@site/static/img/screenshots/event-nodes/comment_node.png)
