...
Needs a text box child node that can be a [LineEdit](https://docs.godotengine.org/en/stable/classes/class_lineedit.html), [TextEdit](https://docs.godotengine.org/en/stable/classes/class_textedit.html) or [ExpandableTextBox](./expandable-text-box).
